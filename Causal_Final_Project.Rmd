...
sigma_mat[lower.tri(sigma_mat)] <- c(0.7, 0.8, 0.65, 0.9,0.92, 0.84)
sigma_mat <- t(sigma_mat)
sigma_mat[lower.tri(sigma_mat)] <- c(0.7, 0.8, 0.65, 0.9,0.92, 0.84)
Sigma <- t(sigma_mat) %*% sigma_mat
Sigma <- Sigma/1.5
diag(Sigma) <- c(20, 1, 1, 1)
...
Y0_nl <- 50 + (0.08*(X_mat$beta0) + runif(n, 0.02, 0.2)*(X_mat$Weight^3) + log(seq(4, n+3, 1))*(X_mat$Age^7) + 2*exp(X_mat$Size_Tumor) + 0.22*(X_mat$HBP^2) + X_mat$Relapse) *(10^-10) + 10*X_mat$Gender + 15*(1-X_mat$Gender) +rnorm(n,0,1)

Y1_nl <- 50 + (0.08*(X_mat$beta0) + runif(n, 0.02, 0.2)*(X_mat$Weight^3) + log(seq(4, n+3, 1))*(X_mat$Age^7) + 2*exp(X_mat$Size_Tumor) + 0.22*(X_mat$HBP^2) + X_mat$Relapse) *(10^-10) + 10*X_mat$Gender + 15*(1-X_mat$Gender) +rnorm(n,0,1) + tau
