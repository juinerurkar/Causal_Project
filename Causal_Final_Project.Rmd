...
sigma_mat[lower.tri(sigma_mat)] <- c(12.72, 5.81, 19, 3.5, 9.5, 5.65)
sigma_mat <- t(sigma_mat)
sigma_mat[lower.tri(sigma_mat)] <- c(12.72, 5.81, 19, 3.5, 9.5, 5.65)

diag(sigma_mat) <- c(20, 10, 2, 25)
...
Y1_nl <- 50 + (sin(X_mat$Weight^(1/3)) + (X_mat$Age^6) + exp(X_mat$Size_Tumor) + X_mat$Relapse) *(10^-9) + rbeta(n,0, 1)+ tau
